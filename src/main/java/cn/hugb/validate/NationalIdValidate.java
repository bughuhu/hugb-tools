...
public class NationalIdValidate {
	 ...
	 * @return 错误信息或成功信息
	 */
	public static String isNationalId(String IDStr) throws ParseException {
	...
	public static void main(String[] args) throws ParseException {
		String IdCard = "110111198909225018";
		System.out.println(isNationalId(IdCard));
		IdCard = "110111198909225014";
		System.out.println(isNationalId(IdCard));
	}
}
